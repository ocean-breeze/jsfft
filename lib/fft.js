...
!function(exports, complex_array) {
  ...
  exports.ensureComplexArray = ensureComplexArray;
  ...
  // filtered input.
  // filterer accepts freq, i, n and modifies freq.real and freq.imag.
  ComplexArray.prototype.spectrumMap = function(filterer) {
    var spectrum;
    return ensureComplexArray(filterer(spectrum=this.FFT())||spectrum).InvFFT()
  }
  ...
  exports.spectrumMap = function(input, filterer) {
   return ensureComplexArray(input).spectrumMap(filterer)
  }
